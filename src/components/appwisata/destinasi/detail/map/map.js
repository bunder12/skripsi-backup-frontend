...
const Map = ({lat, lang}) => {
    const data = [ 
      {
        icon: L.icon({ iconUrl: "https://i.postimg.cc/h4b7wG7D/danau.png"}),
        center : [-2.5478741, 106.3506705]
      },
  ];

  return (
    <>
  <MapContainer className='w-[100%] h-[60vh] sm:h-[40vh] -z-10 sm:z-0 outline-none rounded-md'  center={[-2.5478741, 106.3506705]} zoom={14}>
  <TileLayer
      ...
      {
        data.map(datas => (
  <Marker position={datas.center} icon={datas.icon}>
    <Popup>
